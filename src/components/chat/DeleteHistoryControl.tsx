 ...
 *
 * 흐름:
 * - 휴지통 클릭 → 인라인 확인("답변도 함께 삭제됩니다 · 삭제 · 취소")
    ...
    return (
      <div className="flex items-center gap-2 whitespace-nowrap text-xs">
        <span className={deleteFailed ? 'text-destructive' : 'text-muted-foreground'}>
          {deleteFailed ? '삭제에 실패했어요' : '답변도 함께 삭제됩니다'}
        </span>
        ...
        <button
          ...
          disabled={isDeleting}
          aria-label="삭제 확인"
          className="cursor-pointer font-medium text-destructive hover:underline focus-visible:outline-none disabled:cursor-default disabled:opacity-60"
        >
